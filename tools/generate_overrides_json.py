...
for q in questions:
    ...
    is_old_demerit = ("記點" in qtext_clean or "違規點數" in qtext_clean) and ("6" in qtext_clean or "六" in qtext_clean) and "點" in qtext_clean and ("個月" in qtext_clean or "月" in qtext_clean) and "吊扣" in qtext_clean
    if is_old_demerit:
    ...
    elif ("記點" in qtext_clean or "違規點數" in qtext_clean) and ("1年" in qtext_clean or "一年" in qtext_clean) and "吊扣" in qtext_clean and ("2次" in qtext_clean or "二次" in qtext_clean):
    ...
    elif ("最高時速" in qtext_clean or "最高速限" in qtext_clean or "時速" in qtext_clean) and ("60" in qtext_clean or "六十" in qtext_clean) and ("超速" in qtext_clean or "牌照" in qtext_clean or "罰鍰" in qtext_clean):
    ...
    elif "電動自行車" in qtext_clean and "型式審驗" in qtext_clean and "速率" in qtext_clean:
    ...
    elif "消防栓" in qtext_clean and ("20公尺" in qtext_clean or "25公尺" in qtext_clean or "20米" in qtext_clean or "25米" in qtext_clean):
